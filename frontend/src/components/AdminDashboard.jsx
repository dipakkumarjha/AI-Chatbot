...
const HARDCODED_PASSWORD = "Dipak@2123";
      ...
      <nav className="navbar navbar-expand-lg navbar-dark bg-dark shadow-sm">
        <div className="container-fluid px-4">
          <a className="navbar-brand d-flex align-items-center gap-2" href="#">
            <span>💬</span> <strong>Jha Admin Portal</strong>
          </a>
          ...
          {selectedChat ? (
            ...
            <div className="p-4 flex-grow-1 overflow-auto bg-light">
              <div className="card shadow-sm border-0 bg-white p-4 mb-4">
                ...
                <p className="text-muted">Real-time usage and onboarding stats for your Jha chatbot.</p>
                <hr />
