    ...
    try {
      ...
      if (res.ok) {
        ...
        setMessages([
          {
            sender: 'ai',
            text: `Hi **${data.visitorName}**! I'm the AI Guide for **theDipak** platform. I see you are a **${professionInput}** aiming to: *"${goalInput.trim()}"*. How can I help you navigate our core tracks (DSA 360, Elevate Full Stack, System Design), notes vault, or handbooks today?`,
            createdAt: new Date()
          }
        ]);
      } else {
        ...
        <div>
          <div className="d-flex justify-content-between align-items-center pb-3 border-bottom mb-4">
            <div className="d-flex align-items-center gap-2">
              ...
              <h5 className="mb-0 fw-bold text-dark">Jha Chat bot</h5>
            </div>
    ...
    <div className="chat-container">
      ...
      <div className="d-flex justify-content-between align-items-center px-3 py-2 border-bottom shadow-sm bg-white">
        <div className="d-flex align-items-center gap-2">
          <span className="fs-4">💬</span>
          <div>
            <h6 className="mb-0 fw-bold text-dark">Jha Chat bot</h6>
