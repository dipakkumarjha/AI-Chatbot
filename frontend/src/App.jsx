      ...
      <div className="row justify-content-center">
        <div className="col-md-8 text-center">
          <div className="card shadow-sm border-0 p-5 bg-white">
            <h1 className="display-5 fw-bold text-dark mb-3">💬 JhaAI Hub</h1>
            <p className="lead text-muted mb-4" style={{ fontSize: '1.05rem' }}>
              Welcome to the MERN development dashboard for the <strong>JhaAI</strong> chatbot widget.
            ...
            <div className="text-start">
              ...
              <ul className="text-muted small">
                ...
                <li className="mb-2">Open the main root homepage <code>index.html</code> (pointing to <a href="https://google.com" target="_blank" rel="noreferrer">https://oltechsolutions.co.in/</a> for empty links) to see the floating chatbot widget working live!</li>
              </ul>
            </div>
            <div className="text-center pt-3 border-top mt-4 text-muted small" style={{ fontSize: '0.8rem' }}>
              Powered by <span className="fw-semibold">JhaAI</span>
            </div>
          </div>
        </div>
      </div>
